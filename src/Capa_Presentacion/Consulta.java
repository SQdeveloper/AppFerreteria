...
public class Consulta extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        jLabel7.setText("by designed Cercana");

        jLabel8.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/herraC.png"))); // NOI18N

        jButton1.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/flechadaffd.png"))); // NOI18N
    ...
    public void inicializar_valores(){
        txtProducto.setText(temp.lista.get(temp.in).getProducto());
        txtCantidad.setText(temp.lista.get(temp.in).getCantidad());
        txtPrecio.setText(temp.lista.get(temp.in).getPrecio());
        txtFecha.setText(temp.lista.get(temp.in).getFecha());
        txtCodigo.setText(temp.lista.get(temp.in).getCodigo());       
    }
